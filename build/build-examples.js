...
const main = () => {
  ...
  mkdirp(examplesDir, (err) => {
    ...
    files.forEach(file => {
      ...
      const prefix = `ci${type.charAt(0).toLowerCase()}`
      
      let html = `<!DOCTYPE html>\n<html lang="en">\n<head>\n  <meta charset="UTF-8">\n`
      html += `  <title>CoreUI Icons - ${type}</title>\n`
      html += `  <link rel="stylesheet" type="text/css" href="https://unpkg.com/@coreui/coreui@3.0.0-beta.4/dist/css/coreui.min.css">\n`
